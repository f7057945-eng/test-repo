      ...
      <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav" size="08">
                        ...
                        <form id="form" class="splash-container" method="post" action="update_admin.php">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form-control-lg" type="text" required="" name="admin_password" value="<?php echo md5($res['admin_password']);?>">
                                    </div>
