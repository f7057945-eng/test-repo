    ...
    <form id="form" class="splash-container" data-parsley-validate="" method="post" action="insert_admin.php">
        <div class="card text-dark">
            <div class="card-header">
                <h3 class="mb-1 text-dark">Registrations Form</h3>
                <p>Please enter your user information.</p>
            </div>
            <div class="card-body">
                <div class="form-group">
                    <input class="form-control form-control-lg" type="text" name="admin_username" data-parsley-trigger="change" required="" placeholder="Username" pattern="/^[a-zA-Z]+$/" autocomplete="off">
                </div>
                <div class="form-group">
