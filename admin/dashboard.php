                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card bg-success">
                            <div class="card-body">
                                ...
                                ?>
                                <p class="card-text text-white">Number of users in database = <?php echo $res_users;?>.</p>
                                <a href="view_users.php" class="btn btn-rounded btn-light">View</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card bg-secondary">
                            <div class="card-body">
                                ...
                                ?>
                                <p class="card-text text-dark">Number of categories in database = <?php echo $res_category;?>.</p>
                                <a href="view_category.php" class="btn btn-rounded btn-dark">View</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
