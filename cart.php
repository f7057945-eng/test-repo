...
"></i></span>
        ...
        <!-- <div class="dashboard-wrapper"> -->
            <div class="container-fluid dashboard-content bg-white">    
                ...
                <div class="row mx-8">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 bg-white text-dark">
                    	<div class="card">
                    		<div class="card-body">
                    				...
                    				<table class="table table-bordered">
                    					...
                    					<tbody>
                    						...
                    						<tr>
								                ...
								                <td><input class="form-control" type="number" min="1" max="100" step="1" value="1" name="product_quantity[]" onchange="prodTotal(this)"></td>
                    					    ...
                    					    <tr>
                                                ...
                                                <td colspan="2" align="left"> Rs. 150 </td>
                                            </tr>
                                            <tr>
                    					    	<td colspan="4" align="right">Total Amount:</td>
                    					    	<td colspan="2" id="total_amount"><span>Rs. <?php if ($printCount == 0){echo 0;} else {echo $total_amount + 150;}?></span><input type="hidden" name="hidden_total_amount" value="<?php echo $total_amount + 150;?>"></td>
                    					    </tr>
                                            <tr>
                                                <td colspan="3">
                    					    ...
                    					    <tr>
                    					    	<td colspan="6" align="right">
                                                    ...
                                                    <a href="index.php" class="btn btn-primary">Go To Website</button>
    ...
    <script>
        ...
        function prodTotal(quantity) { 
        	...
        	var total = quantity.value * price + 150;
