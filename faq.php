...
$faqs = [
    "Do you offer gluten-free option?" => "Yes, we offer gluten-free options for many of our products.",
    "How long do your baked goods stay fresh?" => "Our baked goods are best consumed within 3-5 days of purchases, but can be stored for up to 7 days.",
    "How long does shipping take?" => "Shipping typicallytakes 1-3 business days, depending on your location.",
    "Can I cusomize my order?" => "Yes, we offer customization options for many of our products. Please contact us for more information.",
...
<div class="container">
    ...
    <?php foreach ($faqs as $question => $answer): ?>
        <div class="faq">
            <h2 onclick="toggleAnswer(this)"><?php echo $question; ?></h2>
            <p><?php echo $answer; ?></p>
        </div>
    <?php endforeach; ?>
</div>
