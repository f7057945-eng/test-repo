...
if (isset($_GET['logout_success']) && $_GET['logout_success'] == 1) {
    echo "<script>alert('cart_product removed!')</script>";
...
"></i></span>
        ...
        <!-- <div class="dashboard-wrapper"> -->
            <div class="container-fluid dashboard-content bg-white box-shadow: 0 0.5rem 0.5rem rgb(206, 223, 254);">    
                <div class="row">
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner rounded">
                                ...
                                <div class="carousel-item">
                                    ...
                                    <div class="carousel-caption d-md-block pb-5">
                                        <h3 class="text-white">Pure pastry delight</h3>
                                ...
                                <div class="carousel-item">
                                    ...
                                    <div class="carousel-caption d-md-block pb-5">
                                        <h3 class="text-white">Simply delicious</h3>
                                        <p>From dough to perfection, every step is a labor of love.</p>
                                        <a href="about.php" class="btn btn-rounded btn-outline-light">Read More</a>
                                    </div>
                                </div>
                                <div class="carousel-item">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="card text-center p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text text-dark">Our very first priority is the quality we never compromised in the quality of our bakery products.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="card text-center p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text text-dark">Our every product is fresh and made with natural ingredients we do not use the artificial food ingredient in our products.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="card text-center p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text text-dark">We provide free delivery to our customers. We deliver in 1 hr from the time customer order the product.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mx-5 hero-image rounded">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 p-3 hero-text">
                        <h1 class="text-dark">Always happy to hear from you.</h1>
