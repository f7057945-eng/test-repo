        ...
        <div class="card text-dark">
            ...
            <div class="card-body">
                <div class="form-group">
                    <input class="form-control form-control-lg" type="text" name="users_username" data-parsley-trigger="change" required="" placeholder="Username" autocomplete="off" pattern="/^[a-zA-Z]+$/">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                <input class="form-control form-control-lg" id="pass1" type="password" required placeholder="Password" name="users_password" minlength="6" maxlength="8">
                </div>
                <div class="form-group">
                <input class="form-control form-control-lg" data-parsley-equalto="#pass1" type="password" required placeholder="Confirm password" minlength="6" maxlength="8">
                </div>
                <div class="form-group">
                    <input class="form-control form-control-lg" type="tel" name="users_mobile" data-parsley-trigger="change" required="" placeholder="Mobile no." pattern = "/^(?:\+92|0)?3[0-9]{2}[0-9]{7}$/" autocomplete="off">
                </div>
                <div class="form-group">
